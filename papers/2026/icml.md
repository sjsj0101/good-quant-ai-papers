...
**Catalog ID:** 2026-icml-yao-linearly-convergent-proximal

**Authors:** Xiaoting Yao, Na Zhang
...
### [Adversarially Robust Control of Conditional Value-at-Risk via Kelly Conformal Inference](<https://openreview.net/forum?id=Vhesstbfg6>)

**Catalog ID:** 2026-icml-chen-adversarially-robust-cvar
...
### [Decision-focused Sparse Tangent Portfolio Optimization](<https://openreview.net/forum?id=KV7XHF0IbK>)

**Catalog ID:** 2026-icml-jeon-decision-focused-sparse-tangent
...
### [Error Propagation in Dynamic Programming: From Stochastic Control to American Option Pricing](<https://icml.cc/virtual/2026/poster/65273>)

**Catalog ID:** 2026-icml-della-vecchia-error-propagation

**Authors:** Andrea Della Vecchia, Damir Filipovic
...
**Why it matters:** Clarifies when local model errors remain controlled in sequential pricing and exercise decisions.

**Links:** [Official venue record](<https://icml.cc/virtual/2026/poster/65273>) · [Paper](<https://icml.cc/virtual/2026/poster/65273>)

---

### [Global Merger-Arbitrage Forecasting with Language Models](<https://icml.cc/virtual/2026/poster/60833>)

**Catalog ID:** 2026-icml-jajal-global-merger-arbitrage

**Authors:** Hinal Jajal, Michał Mucha, Charles Sweat, Chris Pulman, Charlie Flanagan, Peter Anderson
...
### [Learning the ESG Geometry with Domain Aware Language Models](<https://icml.cc/virtual/2026/poster/65502>)

**Catalog ID:** 2026-icml-pimparkhede-learning-esg-geometry

**Authors:** Kunal Pradeep Pimparkhede, Chirayu Chaurasia, Jatin Roy, Mahesh Mohan Mohanachandran Radhamany
...
### [MarketSim: Simulating Stock Markets with Large-Scale Generative Agents](<https://openreview.net/forum?id=EzpJxPDqXB>)
...
**Focus:** Simulates stock-market dynamics through a large population of generative agents with heterogeneous behaviors.

**Why it matters:** Creates an experimental environment for studying emergent market outcomes and stress scenarios before live deployment.

**Links:** [Official venue record](<https://icml.cc/virtual/2026/poster/65297>) · [Paper](<https://openreview.net/forum?id=EzpJxPDqXB>)
...
**Why it matters:** Connects market-path geometry directly to portfolio decisions instead of optimizing an intermediate forecast loss.

**Links:** [Official venue record](<https://icml.cc/virtual/2026/poster/62694>) · [Paper](<https://openreview.net/forum?id=eBM5ALLJNx>)
...
### [Position: Evaluating LLMs in Finance Requires Explicit Bias Consideration](<https://icml.cc/virtual/2026/poster/67204>)

**Catalog ID:** 2026-icml-kong-evaluating-finance-bias
...
**Why it matters:** Point-in-time universes and realistic trading frictions determine whether reported forecasting and investment performance is valid.

**Links:** [Official venue record](<https://icml.cc/virtual/2026/poster/67204>) · [Paper](<https://icml.cc/virtual/2026/poster/67204>)
...
**Catalog ID:** 2026-icml-kuular-behavioral-proxy-conditioning

**Authors:** Elena Kuular, Junsuk Choe
...
**Focus:** Conditions a pretrained diffusion model on behavioral proxies to generate financially meaningful stress scenarios.

**Why it matters:** Expands scenario design beyond historical replay while retaining interpretable links to stressed market behavior.

**Notes:** 2nd ICML Workshop on Foundation Models for Structured Data (FMSD 2026); non-archival workshop paper.

**Links:** [Official venue record](<https://openreview.net/forum?id=xrwkOUb8kp>) · [Paper](<https://openreview.net/forum?id=xrwkOUb8kp>)
...
**Links:** [Official venue record](<https://openreview.net/forum?id=pTiRAPtDzK>) · [Paper](<https://openreview.net/forum?id=pTiRAPtDzK>)
...
**Catalog ID:** 2026-icml-guan-leakage-aware-benchmarking
...
**Focus:** Benchmarks macro-conditioned equity-factor ranking using only data and nowcasts available at each historical decision time.

**Why it matters:** Separates genuine forecasting value from publication-lag leakage in investment backtests.

**Notes:** ICML 2026 Workshop on Forecasting as a New Frontier of Intelligence; non-archival workshop paper.

**Links:** [Official venue record](<https://openreview.net/forum?id=mi8QiWomm3>) · [Paper](<https://arxiv.org/abs/2606.22719>)

---

### [Learning to Trade Like an Expert: Cognitive Fine-Tuning for Stable Financial Reasoning in Language Models](<https://arxiv.org/abs/2604.16862>)

**Catalog ID:** 2026-icml-pan-learning-to-trade-expert
...
**Focus:** Fine-tunes open language models on structured financial reasoning examples and evaluates transfer to chronological trading simulations.

**Why it matters:** Tests whether explicit decision reasoning produces more stable trading behavior across market regimes.

**Notes:** FoGen 2026, the ICML Workshop on Foundations of Deep Generative Models: Understanding Memorization, Generalization, and Reasoning; non-archival workshop paper.

**Links:** [Official venue record](<https://openreview.net/forum?id=01bO7bdq4e>) · [Paper](<https://arxiv.org/abs/2604.16862>)

---

### [Mechanism-Inspired Aggregation for Multi-Agent Alpha Discovery: Optimizing Agent Distributions in Heterogeneous LLM Markets](<https://openreview.net/forum?id=mbstEcHW0R>)

**Catalog ID:** 2026-icml-kumar-mechanism-inspired-aggregation
...
**Focus:** Aggregates heterogeneous language-model agents by optimizing their population mix for multi-agent alpha discovery.
...
### [Reflexivity as Prompt: Does Awareness of Self-Reinforcing Market Dynamics Improve LLMs as Financial Market Forecasters?](<https://arxiv.org/abs/2606.00061>)
...
**Authors:** Srijan Sood, Maxime Kawawa-Beaudan, Daniel Borrajo, Manuela Veloso

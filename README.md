...
| [Tail Annealing for Heavy-Tailed Flow Matching](<https://icml.cc/virtual/2026/poster/60665>)<br><sub>Jean Pachebat</sub> | Main<br><sub>Poster</sub> | Applies tail-annealed flow matching to heavy-tailed targets and validates generated samples on Fama–French return data. | — | More faithful extreme quantiles support CVaR estimation and financial stress analysis where tail errors dominate risk. |
